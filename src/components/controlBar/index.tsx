...
const RabbitIcon = () => (
<svg  fill={styles.colors.gray2} height="8000px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 512 512" >
<g>
	<g>
        ...
        <ControlButton
            icon={
              <SpeedIconWrapper isHighSpeed={latestStatus.robotSpeed === 0}>
                {latestStatus.robotSpeed === 0 ? <RabbitIcon /> : <TortoiseIcon />}
              </SpeedIconWrapper>
            }
            style={{
              width: 112,
            ...
            label={t('control.button.change_speed')}
            onTap={robotSpeed}
          />
        <Divider />
